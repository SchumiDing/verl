...
rjob delete rdkit-grpo-uspto-50k-match
rjob submit \
    --name=rdkit-grpo-uspto-50k-match \
    --gpu=8 \
    --memory=1280000 \
    --cpu=96 \
    ...
    -P 2 \
    -- bash -exc /mnt/shared-storage-user/mineru4s/dingruiyi/verl_wanjuan/train_rdkit_grpo.sh