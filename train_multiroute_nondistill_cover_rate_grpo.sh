...
OUTPUT_DIR="/mnt/shared-storage-user/mineru4s/dingruiyi/wanjuan-0314/checkpoints_rl/multiroute_nonedistill_cover_rate_grpo_${TIMESTAMP}"
mkdir -p "$OUTPUT_DIR"
cp "$0" "$OUTPUT_DIR/"
...
echo "  Nodes: $NNODES"
echo "  Reward Manager: multiroute_nonedistill_cover_rate_cot"
echo "=========================================="
...
python3 -m verl.trainer.main_ppo \
    ...
    reward.reward_manager.name=multiroute_nonedistill_cover_rate_cot \
    reward.reward_manager.source=register \
    reward.num_workers=8 \
    reward.reward_model.enable=False \
    trainer.critic_warmup=0 \
    trainer.logger='["console", "file"]' \
    trainer.project_name='multiroute_nonedistill_cover_rate_grpo' \
    trainer.experiment_name='qwen_multiroute_nonedistill_cover_rate_grpo_test' \
