...
OUTPUT_DIR="/mnt/shared-storage-user/mineru4s/dingruiyi/wanjuan-0314/checkpoints_rl/forward_rdkit_grpo_cot_v1_no_sft_${TIMESTAMP}"
mkdir -p "$OUTPUT_DIR"
cp "$0" "$OUTPUT_DIR/"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='forward_rdkit_grpo_cot_v1_no_sft' \
    trainer.experiment_name='qwen3.5_4b_forward_rdkit_grpo_cot_v1_no_sft' \
