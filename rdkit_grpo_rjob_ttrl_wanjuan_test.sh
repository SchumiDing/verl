...
rjob delete rdkit-grpo-wanjuan-test-ttrl
rjob submit \
    --name=rdkit-grpo-wanjuan-test-ttrl \
    --gpu=8 \
    --memory=1280000 \
    --cpu=96 \
    ...
    -P 2 \
    -- bash -exc /mnt/shared-storage-user/mineru4s/dingruiyi/verl_wanjuan/train_forward_rdkit_grpo_ttrl_wanjuan_test.sh