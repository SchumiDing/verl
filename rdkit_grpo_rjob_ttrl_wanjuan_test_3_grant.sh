...
rjob delete rdkit-grpo-wanjuan-test-ttrl-3-grant
rjob submit \
    --name=rdkit-grpo-wanjuan-test-ttrl-3-grant \
    --gpu=8 \
    --memory=1280000 \
    --cpu=96 \
    ...
    -P 2 \
    -- bash -exc /mnt/shared-storage-user/mineru4s/dingruiyi/verl_wanjuan/train_forward_rdkit_grpo_ttrl_wanjuan_test_3_grant.sh