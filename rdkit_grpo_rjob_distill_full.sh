...
rjob delete multiroute-distill-grpo-full
rjob submit \
    --name=multiroute-distill-grpo-full \
    --gpu=8 \
    --memory=1280000 \
    --cpu=96 \
    ...
    --host-network=true \
    -P 1 \
    -- bash -exc /mnt/shared-storage-user/mineru4s/dingruiyi/verl_wanjuan/train_multiroute_distill_grpo_full.sh