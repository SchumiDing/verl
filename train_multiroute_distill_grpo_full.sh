...
OUTPUT_DIR="/mnt/shared-storage-user/mineru4s/dingruiyi/wanjuan-0314/checkpoints_rl/multiroute_distill_grpo_full_${TIMESTAMP}"
mkdir -p "$OUTPUT_DIR"
cp "$0" "$OUTPUT_DIR/"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='multiroute_distill_grpo_full' \
    trainer.experiment_name='qwen_multiroute_distill_grpo_full' \
